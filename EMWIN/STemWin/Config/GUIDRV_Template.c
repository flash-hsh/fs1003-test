...
//定义LCD的命令和数据位.
//u32 UCGUI_LCD_CMD  = 0X6C001FFE; //FSMC_A12//地址为0X6C00007E;  0111 1110  FSMC_A6为0 
u32 UCGUI_LCD_CMD  = 0X6C0001FE; //FSMC_A12//地址为0X6C00007E;  0111 1110  FSMC_A6为0 
u32 UCGUI_LCD_DATA = 0X6C001000; //FSMC_A12//地址为0x6C000080;  1000 0000  FSMC_A6为1
/*********************************************************************
*
*       Defines
*
...
static void _SetPixelIndex(GUI_DEVICE * pDevice, int x, int y, int PixelIndex) {
    ...
    GUI_USE_PARA(PixelIndex);
    {
		...
		TFT_GUI_DrawPoint(x,y,PixelIndex);
    }
