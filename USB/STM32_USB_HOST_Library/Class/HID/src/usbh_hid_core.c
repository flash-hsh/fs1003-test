...
//	printf("HID_REQ_GET_HID_DESC=%d\r\n",HID_REQ_GET_HID_DESC);//2
//	printf("HID_REQ_GET_REPORT_DESC=%d\r\n",HID_REQ_GET_REPORT_DESC);//1
//	printf("HID_REQ_SET_IDLE=%d\r\n",HID_REQ_SET_IDLE);//3
//	printf("HID_REQ_SET_PROTOCOL=%d\r\n",HID_REQ_SET_PROTOCOL);//4
	
	//printf("HID_Machine.ctl_state2=%d\r\n",HID_Machine.ctl_state);
  switch (HID_Machine.ctl_state)
  {
  case HID_IDLE:  //0
  case HID_REQ_GET_HID_DESC: //2
    ...
    break;     
  case HID_REQ_GET_REPORT_DESC: //1
