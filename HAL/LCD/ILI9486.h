...
//使用NOR/SRAM的 Bank1.sector4,地址位HADDR[27,26]=13 A12作为数据命令区分线 
//注意设置时STM32内部会右移一位对其! 111110=0X3E		1 1111 1111 1110=0x1ffe ->右移一位0111111111111	    
...
#define BACK_COLOR_ERR 	YELLOW
extern u16 PointColor;
